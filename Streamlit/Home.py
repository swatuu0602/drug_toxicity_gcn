...
from Pages.Toxicity_Prediction import predict_output
from Pages.Configuration import configure_model
...
def Home_Page():
    ...
    with col2:
        st.image('/home/yuvraj/Github/Deep_Learning_Projects/Drug_Toxicity_Prediction/Images/Home.jpg')



page_names_to_funcs = {
    "Project Overview 📑": Home_Page,
"Model Configuration":configure_model,
    "Toxicity Prediction 🤔": predict_output
}
